        ...
        public List<Producto> Listar()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                try
                {
                    ...
                    query.AppendLine("SELECT p.idProducto,p.Codigo,p.Nombre,p.Descripcion,c.idCategoria,c.Descripcion AS DescripcionCategoria,p.Stock,p.PrecioVenta,p.Estado FROM PRODUCTO p");
